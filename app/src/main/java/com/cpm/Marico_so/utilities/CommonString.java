...
public class CommonString {
    ...
    public static String URL = "http://maricoso.parinaam.in/Webservice/MaricoSOservice.svc/";
//    public static String URL = "http://marico.parinaam.in/webservice/Maricoservice.svc/";
  //  public static String URL = "http://maricoso.parinaam.in/Webservice/MaricoSOservice.svc/";
    public static String URL3 = "http://maricoso.parinaam.in/webservice/Imageupload.asmx/";
    public static String URLGORIMAG = "http://maricoso.parinaam.in/webservice/Imageupload.asmx/";
    public static final String BACKUP_FILE_PATH = Environment.getExternalStorageDirectory() + "/MaricoSO_Backup/";
    ...
    //File Path
    public static final String FILE_PATH = Environment.getExternalStorageDirectory() + "/.MaricoSO_Images/";
    public static final String FILE_PATH1 = Environment.getExternalStorageDirectory() + "/SaleConfirmation_Images/";
    public static final String FOLDER_NAME_IMAGE = ".MaricoSO_Images";
    public static final String FILE_PATH_Downloaded = Environment.getExternalStorageDirectory() + "/MaricoSO_Downloaded_Img/";
    ...
    public static final String TABLE_AUDIT_HEADER_DATA = "Audit_Header_Data";
    public static final String TABLE_AUDIT_CHILD_DATA = "Audit_Child_Data";
    public static final String KEY_TIME_COMPLETION = "Time_Completion";
    public static final String KEY_START_TIME = "Start_Time";
    public static final String KEY_END_TIME = "End_Time";
    public static final String KEY_SKU = "Sku";
    public static final String TABLE_AUDIT_COUNT_DOWN_TIMER = "Audit_Count_Down_Timer";
    ...
    public static final String CREATE_TABLE_AUDIT_HEADER_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_AUDIT_HEADER_DATA
            + " ("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
    ...
    public static final String CREATE_TABLE_AUDIT_CHILD_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_AUDIT_CHILD_DATA
            + " ("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"

            + CommonString.KEY_COMMON_ID
            + " INTEGER,"
    ...
    public static final String CREATE_TABLE_AUDIT_COUNT_DOWN_TIMER = "CREATE TABLE IF NOT EXISTS "
            + TABLE_AUDIT_COUNT_DOWN_TIMER
            + " ("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
            ...
            + CommonString.KEY_START_TIME
            + " VARCHAR,"

            + CommonString.KEY_END_TIME
            + " VARCHAR,"

            + CommonString.KEY_TIME_COMPLETION
            + " VARCHAR"
            + ")";
}
