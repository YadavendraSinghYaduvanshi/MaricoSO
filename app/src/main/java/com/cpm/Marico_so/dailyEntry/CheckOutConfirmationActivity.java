...
import com.cpm.Marico_so.adapter.SkuListAdapter;
import com.cpm.Marico_so.database.MaricoSODatabase;
import com.cpm.Marico_so.getterSetter.ClosingStockData;
...
public class CheckOutConfirmationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        store_name.setText(jcpGetset.getStoreName()+ " ( " + jcpGetset.getStoreId() + " )");
