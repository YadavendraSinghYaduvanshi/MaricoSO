...
public class TesterStockActivity extends AppCompatActivity {
    ...
    private MaricoSODatabase database;
    Dialog dialog;
    Context context;
    ...
    private void declaration() {
        ...
        if (!(testerStockList.size() > 0)) {
            testerStockList = database.getTesterStockData(journeyPlan.getStoreTypeId(), String.valueOf(journeyPlan.getStateId()), journeyPlan.getStoreCategoryId());
        } else {
