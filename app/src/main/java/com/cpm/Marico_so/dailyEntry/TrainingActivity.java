...
public class TrainingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  setTitle("Training - " + visit_date);
       ...
       /* webview_livon.setWebViewClient(new MyWebViewClient());
        ...
        String url = "http://maricoso.parinaam.in/Training/Training.html";
        webview_livon.getSettings().setJavaScriptEnabled(true);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
          //  view.loadUrl(url);
            view.loadUrl("http://maricoso.parinaam.in/Training/Training.html");
            return true;
        }
        ...
        public void onPageFinished(WebView view, String url) {
           ...
           // super.onPageFinished(view, url);
            super.onPageFinished(view, "http://maricoso.parinaam.in/Training/Training.html");
