package com.cpm.Marico_so.password;
...
import com.cpm.Marico_so.LoginActivity;
import com.cpm.Marico_so.blurlockview.BlurLockView;
import com.cpm.Marico_so.blurlockview.Directions.HideType;
import com.cpm.Marico_so.blurlockview.Directions.ShowType;
import com.cpm.Marico_so.blurlockview.Eases.EaseType;
import com.cpm.Marico_so.blurlockview.Password;
import com.cpm.Marico_so.AutoLoginActivity;
import com.cpm.Marico_so.R;
import com.cpm.Marico_so.oneQad.OneQADActivity;
...
public class MPinActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (IS_PASSWORD_CHECK) {
            ...
            blurLockView.setTitle("Please Enter Four Digit MPin " + "(Ver-"+app_ver+")");
        } else {
            blurLockView.setCorrectPassword("abcd");
            blurLockView.setLeftButton("Set MPin");
            blurLockView.setTitle("Please Set Four Digit MPin " + "(Ver-"+app_ver+")" );
        }
